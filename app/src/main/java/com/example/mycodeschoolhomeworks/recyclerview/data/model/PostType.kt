...
abstract class PostType(val type: Int, val url: String) {
    abstract fun bind()
}

class TextPost(type: Int, url : String) : PostType(type, url) {
    override fun bind() {

    }
}

class ImagePost(type: Int, url: String) : PostType(type, url) {
    var imagePost=ImagePost(2, "https://www.saatchiart.com/art/Painting-Everyone-s-Gone/1156185/8268487/view")
...
class VideoPost(type: Int, url: String) : PostType(type, url) {
    override fun bind() {
