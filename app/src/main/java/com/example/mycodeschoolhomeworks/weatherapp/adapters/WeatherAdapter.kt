package com.example.mycodeschoolhomeworks.weatherapp.adapters
...
class WeatherAdapter(val listener: Listener?) :
    ...
    class Holder(view: View, val listener: Listener?) : RecyclerView.ViewHolder(view) {
        ...
        fun bind(item: WeatherModel) = with(binding) {
            ...
            Picasso.get().load("https:" + item.image).into(imageView2)
        }
    }
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): Holder {
        val view =
            LayoutInflater.from(parent.context).inflate(R.layout.list_weather_item, parent, false)
